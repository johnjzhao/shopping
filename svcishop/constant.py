...
SiteDefaultSettings = {
    ...
    "project_subtitle": {
        "value": "Innovation shpping  e-commerce in python",
        "value_type": SettingValueType.string,
        "name": "Project subtitle",
        "description": "A short description of the project.",
    },
    "project_copyright": {
        "value": "COPYRIGHT © 1999–2023 SUNVALLEY COMPUTER INC",
        "value_type": SettingValueType.string,
        "name": "Project Copyright",
        "description": "Copyright notice of the Project like '&copy; 2023 SvciShop'. ",
    },
}
