...
from svcishop.account.models import User, UserAddress
...
from svcishop.database import Column, Model, db
from svcishop.discount.models import Voucher
from svcishop.product.models import ProductVariant
