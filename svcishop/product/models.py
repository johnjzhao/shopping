...
from svcishop.corelib.db import PropsItem
from svcishop.corelib.mc import cache, cache_by_args, rdb
...
class Product(Model):
    ...
    def discounted_price(self):
        from svcishop.discount.models import Sale
    ...
    def __flush_insert_event__(cls, target):
        ...
        if current_app.config["USE_ES"]:
            from svcishop.public.search import Item
