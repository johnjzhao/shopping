...
from svcishop.account.models import Role, User, UserAddress, UserRole
from svcishop.checkout.models import ShippingMethod
from svcishop.constant import (
...
from svcishop.dashboard.models import DashboardMenu
from svcishop.discount.models import Sale, SaleProduct, Voucher
from svcishop.order.models import Order, OrderLine, OrderPayment
from svcishop.product.models import (
